 ...
 * mipi_datarate per lane 445.5Mbps 4 lane
 */
static const struct regval imx307_linear_1920x1080_60fps_mipi_regs[] = {
	{0x3003, 0x01},
	{REG_DELAY, 0x10},
	{0x3000, 0x01},
	{0x3001, 0x00},
 ...
 * mipi_datarate per lane 222.75Mbps 4 lane
 */
static const struct regval imx307_linear_1920x1080_30fps_mipi_regs[] = {
	{0x3003, 0x01},
	{REG_DELAY, 0x10},
	{0x3000, 0x01},
	{0x3001, 0x00},
...
static const struct imx307_mode mipi_supported_modes[] = {
	{
		...
		.hts_def = 0x1130,
		.vts_def = 0x0465,
		.reg_list = imx307_linear_1920x1080_60fps_mipi_regs,
		.hdr_mode = NO_HDR,
		.lanes = 4,
		.freq_idx = 0,
		.bpp = 10,
...
static void imx307_remove(struct i2c_client *client)
{
	struct v4l2_subdev *sd = i2c_get_clientdata(client);
	struct imx307 *imx307 = to_imx307(sd);
